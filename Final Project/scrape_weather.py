...
class WeatherScraper():
    ...
    def parse_website(self, date_input):
        ...
        #print(weather_parser.weather_dict)
...
#    weather_dictionary = myparser.parse_website('3/1985')
#except Exception:
#    weather_file = open("weatherlog.txt", "a", encoding="utf-8")
#    weather_file.write("\nError while creating WeatherScraper() object.")
 #   weather_file.close()
